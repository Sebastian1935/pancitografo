...
const PropuestaArcaPilates = () => {
  return (
    <div className="max-w-4xl mx-auto p-8 bg-amber-50">
      {/* Header */}
      <div className="border-b-2 border-amber-800 pb-6 mb-8">
        <h1 className="text-3xl font-serif text-amber-900 mb-2">
          Propuesta de Sistema de Reservaciones
        </h1>
        <p className="text-lg text-amber-800">Para: Arca Pilates Studio</p>
      ...
      <section className="mb-8 bg-white p-6 rounded-lg shadow-sm border border-amber-200">
        <h2 className="text-2xl font-serif text-amber-900 mb-4 flex items-center gap-2">
      ...
      <section className="mb-8">
        ...
        <div className="space-y-3 mb-6">
          ...
          <div className="flex items-start gap-3 bg-white p-3 rounded-lg shadow-sm">
            ...
            />
            <div>
              <p className="font-semibold text-amber-900">Diseño responsive</p>
              <p className="text-amber-800 text-sm">
        ...
        <h3 className="text-xl font-serif text-amber-900 mb-3 mt-6">
          Lo que NO incluye (puede agregarse posteriormente):
        </h3>
        <div className="space-y-2 text-amber-900 bg-white p-4 rounded-lg shadow-sm">
      ...
      <section className="mb-8 bg-white p-6 rounded-lg shadow-sm border border-amber-200">
        ...
        <div className="space-y-6">
          <div className="border-l-4 border-amber-600 pl-4 bg-amber-50 py-2">
          ...
          <div className="border-l-4 border-amber-800 pl-4 bg-amber-50 py-2">
            <h3 className="font-serif font-bold text-amber-900 mb-2">
      ...
      <section className="mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-3">
          <div className="p-3 bg-white rounded shadow-sm border border-amber-200">
            <p className="font-semibold text-amber-900">
          ...
          <div className="p-3 bg-white rounded shadow-sm border border-amber-200">
            <p className="font-semibold text-amber-900">✓ Paleta de colores</p>
            <p className="text-sm text-amber-800">
      ...
      <section className="mb-8 bg-white p-6 rounded-lg shadow-sm border border-amber-200">
        <h2 className="text-2xl font-serif text-amber-900 mb-6 flex items-center gap-2">
          <DollarSign className="text-amber-700" size={28} />
          Inversión
        </h2>
        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="bg-amber-50 p-4 rounded-lg border-2 border-amber-300">
              <p className="text-3xl font-serif font-bold text-amber-900 mb-2">
                $4,000 MXN
              </p>
            ...
            <div className="mt-4 space-y-2">
              ...
              <div className="pl-4 space-y-2 text-amber-900">
                <p className="flex items-start gap-2">
          ...
          <div>
            ...
            <div className="bg-amber-50 p-4 rounded-lg border-2 border-amber-300">
              <p className="text-2xl font-serif font-bold text-amber-900 mb-2">
                $7 USD mensuales
              </p>
          ...
          <div>
            ...
            <p className="text-amber-900 mb-3">Tienes dos opciones:</p>

            <div className="space-y-3">
              <div className="bg-amber-50 p-4 rounded-lg border border-amber-300">
                <p className="font-serif font-bold text-amber-900 mb-1">
      ...
      <section className="mb-8">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-start gap-3 bg-white p-3 rounded-lg shadow-sm">
            ...
            />
            <div>
              <p className="font-semibold text-amber-900">El sistema es tuyo</p>
              <p className="text-amber-800 text-sm">
      ...
      <section className="mb-8 bg-white p-6 rounded-lg shadow-sm border border-amber-200">
        ...
        <div className="space-y-3">
          <div className="flex items-start gap-3">
            <div className="bg-amber-700 text-white rounded-full w-8 h-8 flex items-center justify-center flex-shrink-0 font-bold">
              1
            </div>
            <div>
              <p className="font-semibold text-amber-900">
      ...
      <section className="mb-8">
        ...
        <div className="text-sm text-amber-900 space-y-2 bg-white p-4 rounded shadow-sm border border-amber-200">
          <p>
      ...
      <section className="mb-8">
        ...
        <p className="text-amber-900 leading-relaxed mb-4">
          Damara, estoy muy entusiasmado con la posibilidad de trabajar con
          Arca. Creo que este sistema va a facilitarles muchísimo la operación
          diaria y tus alumnas van a adorar lo fácil que es reservar sus clases.
        </p>
        <p className="text-amber-900 leading-relaxed mb-4">
      ...
      {/* Footer con Contacto */}
      <div className="border-t-2 border-amber-800 pt-6 mt-8">
        <div className="text-center">
          <p className="font-serif font-bold text-amber-900 text-lg mb-2">
            Sebastián López
          </p>
          <p className="text-amber-800 mb-1">Desarrollador Web</p>
          <p className="text-amber-800 mb-1">📱 662 103 1074</p>
          <p className="text-amber-800">✉️ sebastianlopez1935@gmail.com</p>
        </div>
      </div>

      {/* Nota sobre cómo descargar */}
      <div className="mt-8 p-4 bg-amber-100 border border-amber-400 rounded text-sm text-amber-900">
